...
| [Bolt-RAG-with-Qroq-Qdrant](Bolt-RAG-with-Qroq-and-Qdrant)   | Lightning-fast PDF chat with multi-session support and modern UI.           | Qdrant, Groq, Cohere, LangChain, Streamlit        |
| [rag-interview-prep](rag-interview-prep)   | Prep for the RAG portion of interviews: Q&A by pipeline stage, system-design scenarios, debug exercises, cheat sheets.  | -        |
